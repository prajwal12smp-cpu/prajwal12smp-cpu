...
→ [See it here](https://github.com/prajwal12smp-cpu/SIGN-DETECT)
...
`Python` · `OpenCV` · `MediaPipe` · `scikit-learn` · `Pandas/NumPy` · `Git`

## Let's talk

I'm actively looking for AI/ML Engineer roles. If you're hiring, or just want to talk about computer vision, reach out:

- 💼 [LinkedIn](https://linkedin.com/in/prajwal-shivashimpar-2)
- 📧 prajwal.12smp@gmail.com
